...
//       notifyListeners();
//     }
//     int uId = await SharedPrefsHelper().getSharedPreference('UniversitySelectID', 3);
//     Folder folder;
//     if (refresh ?? false)
//       folder = null;
//     else
...
//       }
//
//       for (Folder folder in _foldersList) await _foldersDao.insertFolder(folder);
//     }
//
//     return folder;
//   }
...
//     for (int i = index; i < length; i++) _list.removeLast();
//     _last = _list.last;
//     notifyListeners();
//   }
//
