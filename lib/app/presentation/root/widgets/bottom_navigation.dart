...
class AppBottomNavigation extends StatelessWidget {
  ...
  const AppBottomNavigation({Key? key, this.state, this.onTabBottomNavigation})
      : super(key: key);
...
class BottomNavBarV2 extends StatelessWidget {
  ...
  BottomNavBarV2({Key? key, this.onTabBottomNavigation, this.state})
      : super(key: key);
              ...
              child: ClipOval(
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    child: SizedBox(
                        width: 14.0.w,
                        child: Center(child: SvgPicture.asset(Assets.svgHome))),
    ...
    return GetBuilder<RootController>(
      builder: (data) {
        return CustomNavigationBar(
            ...
            currentIndex: data.indexPage.value,
