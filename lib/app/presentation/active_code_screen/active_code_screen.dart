            ...
            children: [
              ...
              ListView(
                ...
                children: [
                      ...
                      child: AppButton(
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              final suc = await ActiveCodeProvider().activeCode(code: _activeCodeController.text);
                              print(_activeCodeController.text);
                              isLoading.value = false;
                              if (suc.isRight) {
                                _activeCodeController.clear();
                                BotToast.showText(text: "تم تفعيل الكود بنجاح");
                              }
                            }
                          },
                          buttonText: "تفعيل")),
                  ...
                  GestureDetector(
                    onTap: () => URL.launch("https://www.telegram.me/SomeBot"),
                    child: Center(
                        child: Text(
                      "هل تحتاج مساعدة؟",
